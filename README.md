...
You'll need a package manager. Pip or Conda will do, I personally use [miniconda](https://docs.conda.io/en/latest/miniconda.html). A plus for conda is that you don't need to install python before hand.

Finally if you use conda, specifically miniconda, you need to run `conda install pip`, preferably in an [environment](https://docs.conda.io/projects/conda/en/latest/user-guide/tasks/manage-environments.html).
